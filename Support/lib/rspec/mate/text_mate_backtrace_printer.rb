...
# Based on https://github.com/rspec/rspec-core/blob/2cc12cefece83918b2e0737f43a72be52f195a16/lib/rspec/core/formatters/html_printer.rb
      ...
      class TextMateBacktracePrinter
        ...
        def print_example_failed(pending_fixed, description, run_time, failure_id, exception, extra_content, _escape_backtrace=false)
          ...
          if exception
            ...
            @output.puts "        <div class=\"backtrace\"><pre>#{backtrace}</pre></div>"
          end
